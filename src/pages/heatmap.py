...
def create_heatmap_layout():
    """Create heatmap layout. Loads data on page visit."""
    ...
    customdata = np.stack(
        np.meshgrid(x_ticktext, y_ticktext), axis=-1
    )  # for hovertemplate
...
# Create layout on page visit (lazy loading)
layout = create_heatmap_layout()
